...
TEST(TrieDebugger, TestCase) {
  ...
  std::cout << "answer 1: " << trie.GetRoot()->children_.size() << std::endl;
  std::cout << "answer 2: " << trie.GetRoot()->children_.at('9')->children_.size() << std::endl;
  std::cout << "answer 3: " << *trie.Get<uint32_t>("969") << std::endl;
